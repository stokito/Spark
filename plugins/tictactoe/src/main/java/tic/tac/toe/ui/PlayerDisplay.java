...
/**
 * A display for showing which Mark is yours, your opponent's, and whose turn it is
 * <pre>
...
public class PlayerDisplay extends JPanel {
    ...
    public void setCurrentPlayer(Mark m) {
        _currentMark = m;
        _currentplayer.setIcon(m.getImageSmall());
